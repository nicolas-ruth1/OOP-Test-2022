...
Nematodes are among the most abundant animals on Earth. They occur as parasites in animals and plants or as free-living forms in soil and water. There are around 20,000 named species of nematodes. In today's lab test you will be writing a visualiser for a dataset of nematodes. Here is a video of the finished program:
...
| gender | This is the gender of the nematope. This can be a value of m, f. If the gender is m this indicates male and is drawn with a line and a circle on the last segment. If the value is f, this indicates female and is drawn with a circle in the bottom segment. If the value is h this indicates hermaphrodite and is drawm with both male and female symbols. If the value is n, this indicates no gender and nothing extra is drawn in the last segment
| eyes | This indicates whether or not the nematode has eyes. A value of 1 indicates yes and this is drawn with the two lines and circles drawn in the top segment. A value of 0 indicates that the nematobe has no eyes | 

## Instructions

- Fork this repo
- Set up origin and upstream remotes on your fork
- Write a class called Nematode that has appropriate fields, a constructor, accessor methods and a toString method. Include in your soultion a constructor that takes a TableRow parameter from the Processing library
- Write a method on NematodeVisualiser called loadNematodes to load the csv file and populate an ArrayList of type Nematode
